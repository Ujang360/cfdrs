...
How should [cfdrs](../../../../README.md) standardize shutdown behavior so actors and transport tasks terminate deterministically under graceful and forced stop paths?
