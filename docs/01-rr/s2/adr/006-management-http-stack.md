...
Should cfdrs management endpoints use a full web framework abstraction by default, or use a minimal raw HTTP stack tailored to the management surface only?
