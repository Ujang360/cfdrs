...
Should cfdrs expose metrics through direct Prometheus client types, or through an internal facade API that hides backend-specific types from most crates?
