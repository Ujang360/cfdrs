...
How should cfdrs model datagram session migration so token rebinding, cancellation, and v2 or v3 protocol behavior remain consistent under mixed traffic?
