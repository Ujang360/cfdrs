...
Should cfdrs use a third-party async backoff library directly in runtime code, or maintain a small custom backoff implementation aligned to Go behavior?
