...
| --- | --- | --- |
| **3.0 Foundation** | [thiserror](https://crates.io/crates/thiserror), [anyhow](https://crates.io/crates/anyhow), [serde](https://crates.io/crates/serde), [serde_json](https://crates.io/crates/serde_json), [bytes](https://crates.io/crates/bytes), [uuid](https://crates.io/crates/uuid), [tracing](https://crates.io/crates/tracing), [tracing-subscriber](https://crates.io/crates/tracing-subscriber), [tokio](https://crates.io/crates/tokio) (core features), [once_cell](https://crates.io/crates/once_cell), [parking_lot](https://crates.io/crates/parking_lot) | S2 exit gate |
